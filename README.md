# 💫 About Me:
🔧 About Me: I’m a Embedded Software Engineer with a strong interest in SpringBoot, JavaFX, Laravel, and Microservices.<br>🌱 Learning: Currently diving into microservices to enhance my technical skills.<br>👯 Collaboration: Eager to contribute to and collaborate on open source projects.<br>🤝 Seeking: Looking for advice and support in application development and microservices.<br>💬 Ask Me About: Tech support, SpringBoot, JavaFX, Laravel/Wordpress and my journey into new technologies.<br><br>
